...
**Live:** [https://relaxed-weasel-gogs.cloud.nexlayer.ai](https://relaxed-weasel-gogs.cloud.nexlayer.ai)  
...
**gogs** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/gogs/gogs:latest
    path: /
    servicePorts:
    - 3000
    volumes:
